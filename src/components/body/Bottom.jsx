...
// todo: fix cards to match animation card

function Bottom() {
  return (
    <div id='bottomContentWrapper'>
        <div id="bottomCards" className='md:flex md:flex-wrap md:justify-between'>
            <div id="bottomHeading" className='rounded-[10px] bg-gradient-to-b from-orangeGradientTwo from-0% to-orangeGradientOne to-100% pt-6 pb-8 px-7 text-white text-2xl leading-[32px] text-left font-extrabold mb-4 md:w-[340px] md:pt-[56px] md:pl-8 md:mt-6'>
                <h2>Check out our most popular courses!</h2>
            </div>
                <div id="animationCard" className='flex flex-col items-start text-left bg-white px-7 mb-4 shadow-[0px_25px_50px_rgba(6,22,141,0.0442381)] md:w-[340px] md:pl-8 md:pr-[22px]'>
                ...
                <div id="businessCard" className='flex flex-col items-start text-left shadow-[0px_25px_50px_rgba(6,22,141,0.0442381)] md:w-[340px]'>
